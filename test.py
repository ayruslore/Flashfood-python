...
'''
head = {'Content-Type': 'application/json'}
data = {'name':'Hyderabadi Spice','ID':2,"data":[{"restID":2,"qty_left":10,"qty_sold":0,"dish":"Chicken Tikka","originalPrice":120,"offerPrice":70,"type":"Starters[Non-Veg]","tag":['Non-Veg']},
...
{"restID":2,"qty_left":8,"qty_sold":0,"dish":"Mutton Rogan Josh","originalPrice":170,"offerPrice":120,"type":"Kebab","tag":['Veg']}]}
